...
path <- "/YOUR/PATH/HERE/18S/Samples/"
...
saveRDS(myphyloseq, file=paste(path, "../Phyloseq_object_18S.rds", sep = "")) #Save phyloseq as .rds object so we can use it later in a local version of R for data analysis
