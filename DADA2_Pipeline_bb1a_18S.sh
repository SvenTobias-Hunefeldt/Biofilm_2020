...
WorkingPATH="/YOUR/PATH/HERE/18S"
...
#Demultiplex R1
split_libraries_fastq.py -i ${WorkingPATH}/Undetermined_S0_L001_R1_001.fastq -b ${WorkingPATH}/Undetermined_S0_L001_I1_001.fastq -m ${WorkingPATH}/*.txt -n 0 -o ${WorkingPATH}/test_demultplx_seqs_R1.fna --store_demultiplexed_fastq &

#Demultiplex R2
split_libraries_fastq.py -i ${WorkingPATH}/Undetermined_S0_L001_R2_001.fastq -b ${WorkingPATH}/Undetermined_S0_L001_I1_001.fastq -m ${WorkingPATH}/*.txt -n 0 -o ${WorkingPATH}/test_demultplx_seqs_R2.fna --store_demultiplexed_fastq
...
#Run R script for ASV creation/DADA2 pipeline
Rscript ${WorkingPATH}/DADA2_18S.R


#Run R script for phylogenetic tree creation
Rscript ${WorkingPATH}/Phylogenetic_tree_creation.R
