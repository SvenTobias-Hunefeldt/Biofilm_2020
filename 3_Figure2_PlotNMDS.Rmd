...
Substrate_group = get_variable(Phyloseq_Biofilm_16S_noA@sam_data, "Substrate")
df_tran.dist = phyloseq::distance(Phyloseq_Biofilm_16S_noA, method = "bray")
Depth_ado = pairwise.perm.manova(df_tran.dist, Substrate_group, nperm = 999, p.method = "bonferroni")
Depth_ado
...
```{r}
####Whole community####
Comm_test = phyloseq::distance(method = "bray", Phyloseq_Biofilm_16S_noA)

adonis2(Comm_test ~ 
          Phyloseq_Biofilm_16S_noA@sam_data$Sample_time * 
          Phyloseq_Biofilm_16S_noA@sam_data$Substrate * 
          Phyloseq_Biofilm_16S_noA@sam_data$Mesh_status,
        method = "bray")


####Early####
Comm_test = distance(method = "bray", Phyloseq_Biofilm_16S_noA_T12)

adonis2(Comm_test ~ 
          Phyloseq_Biofilm_16S_noA_T12@sam_data$Sample_time * 
          Phyloseq_Biofilm_16S_noA_T12@sam_data$Substrate * 
          Phyloseq_Biofilm_16S_noA_T12@sam_data$Mesh_status,
        method = "bray")


####Late ####
Comm_test = distance(method = "bray", Phyloseq_Biofilm_16S_noA_T3456)

adonis2(Comm_test ~ Phyloseq_Biofilm_16S_noA_T3456@sam_data$Sample_time *Phyloseq_Biofilm_16S_noA_T3456@sam_data$Substrate * Phyloseq_Biofilm_16S_noA_T3456@sam_data$Mesh_status,
        method = "bray")
```
...
```{r}
####Whole community####
Comm_test = distance(method = "bray", Phyloseq_Biofilm_18S_noA)

adonis2(Comm_test ~ Phyloseq_Biofilm_18S_noA@sam_data$Substrate * Phyloseq_Biofilm_18S_noA@sam_data$Mesh_status,
        method = "bray")


####Early####
Comm_test = distance(method = "bray", Phyloseq_Biofilm_18S_noA_T1)

adonis2(Comm_test ~ Phyloseq_Biofilm_18S_noA_T1@sam_data$Substrate * Phyloseq_Biofilm_18S_noA_T1@sam_data$Mesh_status,
        method = "bray")


####Late ####
Comm_test = distance(method = "bray", Phyloseq_Biofilm_18S_noA_T23456)

adonis2(Comm_test ~ Phyloseq_Biofilm_18S_noA_T23456@sam_data$Sample_time *Phyloseq_Biofilm_18S_noA_T23456@sam_data$Substrate * Phyloseq_Biofilm_18S_noA_T23456@sam_data$Mesh_status,
        method = "bray")
```
##Spearman
```{r Add NMDS1 coordinates to mapping file (alpha_meta_inout)}
...
#Save plot
tiff("/YOUR/PATH/HERE/Figures_Tables/Figure2ms_PlotNMDS.tiff", units = "in", width = 16, height = 6.66, res = 300)
Figure2ms
dev.off()
```
#Community maturation rates
