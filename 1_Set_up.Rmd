...
my_16S_phyloseq = readRDS("/YOUR/PATH/HERE/Phyloseq_object_16S.rds")
...
Mod_16S_map = read.csv("/YOUR/PATH/HERE/16S_Mapping_file.csv", row.names = 1)
...
saveRDS(Rarecurve_16S, "/YOUR/PATH/HERE/16S_Rarecurve.rds")
...
my_18S_phyloseq = readRDS("/YOUR/PATH/HERE/Phyloseq_object_18S.rds")
...
#Import mapping file that contains metadata
Mod_18S_map = read.csv("/YOUR/PATH/HERE/18S_Mapping_file.csv", row.names = 1)
...
#Save plot object for later ggarrange activity
saveRDS(Rarecurve_18S, "/YOUR/PATH/HERE/18S_Rarecurve.rds")
...
#Rarification curves plotting
```{r}
ggarrange(Rarecurve_16S, Rarecurve_18S, common.legend = T,
          legend = "right")

tiff("/YOUR/PATH/HERE/Figures_Tables/SupplementaryFigure2_HighQual.tiff", units = "in", width = 16, height = 8, res = 300)
last_plot()
dev.off()
```
